...
`docker run -ti -v ~/.m2:/home/user/.m2 -v /home/user/che-plugin-menu/:/projects eclipse/che-dev:nightly sh -c "mvn clean install"`
...
Example of running this command
`docker run -it --rm -v /home/user/che-data/:/data -v /home/user/che-samples/che-plugin-menu/assembly/assembly-main/target/eclipse-che-6.13.0/eclipse-che-6.13.0:/assembly -v /var/run/docker.sock:/var/run/docker.sock eclipse/che:nightly start --skip:scripts`
